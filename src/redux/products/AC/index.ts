...
export enum ActionTypes {
    ...
    PRODUCTS_UPDATE_DATA_AFTER_POST_REQUEST = 'PRODUCTS_UPDATE_DATA_AFTER_POST_REQUEST',
    PRODUCTS_UPDATE_DATA_AFTER_PUT_REQUEST = 'PRODUCTS_UPDATE_DATA_AFTER_PUT_REQUEST',
